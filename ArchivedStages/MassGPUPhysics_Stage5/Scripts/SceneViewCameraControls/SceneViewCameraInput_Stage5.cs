...
public struct SceneViewCameraInput_Stage5
{
...
public static class SceneViewCameraInputReader_Stage5
{
    public static SceneViewCameraInput_Stage5 Read(SceneViewCameraSettings_Stage5 settings)
    {
        return new SceneViewCameraInput_Stage5
        {
    ...
    private static bool IsMouseInsideInputArea(SceneViewCameraSettings_Stage5 settings)
    {
