...
public sealed class SceneViewCameraRig_Stage5
{
    private Camera _camera;
    private Transform _point;
    private LocalRotationAndScale_Stage5 _mouseOrbit;
    ...
    public void Initialize(Camera camera, Transform point, LocalRotationAndScale_Stage5 mouseOrbit, Transform target)
    {
        _camera = camera;
        _point = point;
        ...
        _point.position = target != null
            ? SceneViewCameraBoundsUtility_Stage5.CalculateBounds(target).center
    ...
    public void Tick(SceneViewCameraInput_Stage5 input, SceneViewCameraSettings_Stage5 settings, Transform focusTarget)
    {
        if (_camera == null)
            return;
    ...
    public void Focus(Transform target)
    {
        ...
        Bounds bounds = SceneViewCameraBoundsUtility_Stage5.CalculateBounds(target);
    ...
    private void FreeLook(SceneViewCameraInput_Stage5 input, SceneViewCameraSettings_Stage5 settings)
    {
        if (!_freeLooking)
        {
            _freeLooking = true;
        ...
        _freeLookY = LocalRotationAndScale_Stage5.ClampAngle(_freeLookY, -89f, 89f);
    ...
    private void FlyMove(SceneViewCameraInput_Stage5 input, SceneViewCameraSettings_Stage5 settings)
    {
    ...
    private void AltRightDragZoom(SceneViewCameraInput_Stage5 input, SceneViewCameraSettings_Stage5 settings)
    {
        Vector3 mouseDelta = input.MousePosition - _lastMousePosition;
    ...
    private void Pan(SceneViewCameraInput_Stage5 input, SceneViewCameraSettings_Stage5 settings)
    {
    ...
    private void ZoomByMouseWheel(SceneViewCameraInput_Stage5 input, SceneViewCameraSettings_Stage5 settings)
    {
