...
/// </summary>
public class MyCameraManager_Stage3 : MonoBehaviour
{
    [Header("Target")]
    ...
    private readonly SceneViewCameraRig_Stage3 _rig = new SceneViewCameraRig_Stage3();
    ...
    protected virtual void Start()
    {
        ...
        {
            Debug.LogError("[MyCameraManager_Stage3] No camera found. Assign ControlledCamera or enable CreateCameraIfMissing.");
            enabled = false;
            return;
        }
        ...
        _mouseOrbit = ControlledCamera.GetComponent<LocalRotationAndScale_Stage3>();
        if (_mouseOrbit == null)
            _mouseOrbit = ControlledCamera.gameObject.AddComponent<LocalRotationAndScale_Stage3>();
    ...
    private void Update()
    {
        ...
        SceneViewCameraSettings_Stage3 settings = BuildSettings();
        SceneViewCameraInput_Stage3 input = SceneViewCameraInputReader_Stage3.Read(settings);
    ...
    {
        return SceneViewCameraBoundsUtility_Stage3.TransformBounds(matrix, bounds);
    }

    private SceneViewCameraSettings_Stage3 BuildSettings()
    {
        return new SceneViewCameraSettings_Stage3
        {
