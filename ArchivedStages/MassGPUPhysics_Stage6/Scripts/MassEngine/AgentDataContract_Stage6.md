# AgentData Contract - Stage6

`AgentData` is the shared memory layout used by:

- `Scripts/GPUInstancingManager_Stage6.cs`
- `Shaders/AgentDataCommon_Stage6.hlsl`
- `Shaders/AgentSpatialHash_Stage6.compute`
- `Shaders/AgentRuntimeFlow_Stage6.compute`
- `Shaders/AgentCombatSimulation_Stage6.compute`
- `Shaders/AgentLodClassification_Stage6.compute`
- `Shaders/InstancedAgentShader_Stage6.shader`
- `Shaders/LitInstancedAgentShader_Stage6.shader`
- `Shaders/BillboardInstancedAgentShader_Stage6.shader`
...
Stage6 combat data is intentionally kept out of `AgentData` so rendering shaders do not inherit combat-only layout churn. The combat pass uses separate compute-only buffers:
