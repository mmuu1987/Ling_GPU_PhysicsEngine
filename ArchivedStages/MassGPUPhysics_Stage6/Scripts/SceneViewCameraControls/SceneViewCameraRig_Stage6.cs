...
public sealed class SceneViewCameraRig_Stage6
{
    private Camera _camera;
    private Transform _point;
    private LocalRotationAndScale_Stage6 _mouseOrbit;
    ...
    public void Initialize(Camera camera, Transform point, LocalRotationAndScale_Stage6 mouseOrbit, Transform target)
    {
        _camera = camera;
        _point = point;
        ...
        _point.position = target != null
            ? SceneViewCameraBoundsUtility_Stage6.CalculateBounds(target).center
    ...
    public void Tick(SceneViewCameraInput_Stage6 input, SceneViewCameraSettings_Stage6 settings, Transform focusTarget)
    {
        if (_camera == null)
            return;
    ...
    public void Focus(Transform target)
    {
        ...
        Bounds bounds = SceneViewCameraBoundsUtility_Stage6.CalculateBounds(target);
    ...
    private void FreeLook(SceneViewCameraInput_Stage6 input, SceneViewCameraSettings_Stage6 settings)
    {
        if (!_freeLooking)
        {
            _freeLooking = true;
        ...
        _freeLookY = LocalRotationAndScale_Stage6.ClampAngle(_freeLookY, -89f, 89f);
    ...
    private void FlyMove(SceneViewCameraInput_Stage6 input, SceneViewCameraSettings_Stage6 settings)
    {
    ...
    private void AltRightDragZoom(SceneViewCameraInput_Stage6 input, SceneViewCameraSettings_Stage6 settings)
    {
        Vector3 mouseDelta = input.MousePosition - _lastMousePosition;
    ...
    private void Pan(SceneViewCameraInput_Stage6 input, SceneViewCameraSettings_Stage6 settings)
    {
    ...
    private void ZoomByMouseWheel(SceneViewCameraInput_Stage6 input, SceneViewCameraSettings_Stage6 settings)
    {
