...
public sealed class PaintedFlowFieldPainterWindow_Stage5 : EditorWindow
{
    private const string PainterComputePath = "Assets/MassGPUPhysics_Stage5/Shaders/PaintedFlowFieldPainter_Stage5.compute";

    private PaintedFlowFieldAsset_Stage5 asset;
    private PaintedFlowFieldAsset_Stage5 loadedAsset;
    private GPUInstancingManager_Stage5 manager;
    ...
    [MenuItem("MassGPUPhysics/Stage5/Painted Flow Field Painter")]
    public static void ShowWindow()
    {
        GetWindow<PaintedFlowFieldPainterWindow_Stage5>("Painted Flow Field");
    }
    ...
    private void DrawToolbar()
    {
        ...
        manager = (GPUInstancingManager_Stage5)EditorGUILayout.ObjectField("Manager", manager, typeof(GPUInstancingManager_Stage5), true);
        asset = (PaintedFlowFieldAsset_Stage5)EditorGUILayout.ObjectField("Flow Field Asset", asset, typeof(PaintedFlowFieldAsset_Stage5), false);
    ...
    private void CreateAsset()
    {
        ...
        var created = CreateInstance<PaintedFlowFieldAsset_Stage5>();
    ...
    private void TryAdoptSelection()
    {
        ...
        var selectedManager = Selection.activeGameObject.GetComponent<GPUInstancingManager_Stage5>();
