...
public static class MassAgentSpawnUtility_Stage5
{
    public struct CombatSpawnData
    {
        public GPUInstancingManager_Stage5.AgentData[] Agents;
        public int[] TeamIds;
        public int[] Hp;
    ...
    public static GPUInstancingManager_Stage5.AgentData[] BuildInitialAgents(
        int instanceCount,
        Vector3 spawnArea,
    ...
    {
        var agents = new GPUInstancingManager_Stage5.AgentData[Mathf.Max(1, instanceCount)];
        ...
        for (int i = 0; i < agents.Length; i++)
        {
            ...
            agents[i] = new GPUInstancingManager_Stage5.AgentData
            {
                position = position,
        ...
        float animationDuration)
    {
        ...
        {
            Agents = new GPUInstancingManager_Stage5.AgentData[safeCount],
        ...
        for (int i = 0; i < safeCount; i++)
        {
            ...
            data.Agents[i] = new GPUInstancingManager_Stage5.AgentData
            {
                position = position,
