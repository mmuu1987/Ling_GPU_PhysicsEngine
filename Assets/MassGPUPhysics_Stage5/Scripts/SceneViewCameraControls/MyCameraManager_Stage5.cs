...
/// </summary>
public class MyCameraManager_Stage5 : MonoBehaviour
{
    [Header("Target")]
    ...
    private readonly SceneViewCameraRig_Stage5 _rig = new SceneViewCameraRig_Stage5();
    ...
    protected virtual void Start()
    {
        ...
        {
            Debug.LogError("[MyCameraManager_Stage5] No camera found. Assign ControlledCamera or enable CreateCameraIfMissing.");
            enabled = false;
            return;
        }
        ...
        _mouseOrbit = ControlledCamera.GetComponent<LocalRotationAndScale_Stage5>();
        if (_mouseOrbit == null)
            _mouseOrbit = ControlledCamera.gameObject.AddComponent<LocalRotationAndScale_Stage5>();
    ...
    private void Update()
    {
        ...
        SceneViewCameraSettings_Stage5 settings = BuildSettings();
        SceneViewCameraInput_Stage5 input = SceneViewCameraInputReader_Stage5.Read(settings);
    ...
    {
        return SceneViewCameraBoundsUtility_Stage5.TransformBounds(matrix, bounds);
    }

    private SceneViewCameraSettings_Stage5 BuildSettings()
    {
        return new SceneViewCameraSettings_Stage5
        {
