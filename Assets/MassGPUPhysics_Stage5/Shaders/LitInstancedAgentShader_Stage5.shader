Shader "Universal Render Pipeline/MassGPUPhysics_Stage5/LitInstancedAgentShader_Stage5"
{
    // ============================================================
    // LitInstancedAgentShader_Stage5 — 带完整 URP 光照 + 阴影的 VAT 渲染 Shader。
    //
    // 【与 InstancedAgentShader_Stage5 的区别】
