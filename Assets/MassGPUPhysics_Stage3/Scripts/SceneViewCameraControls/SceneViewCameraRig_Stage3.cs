...
public sealed class SceneViewCameraRig_Stage3
{
    private Camera _camera;
    private Transform _point;
    private LocalRotationAndScale_Stage3 _mouseOrbit;
    ...
    public void Initialize(Camera camera, Transform point, LocalRotationAndScale_Stage3 mouseOrbit, Transform target)
    {
        _camera = camera;
        _point = point;
        ...
        _point.position = target != null
            ? SceneViewCameraBoundsUtility_Stage3.CalculateBounds(target).center
    ...
    public void Tick(SceneViewCameraInput_Stage3 input, SceneViewCameraSettings_Stage3 settings, Transform focusTarget)
    {
        if (_camera == null)
            return;
    ...
    public void Focus(Transform target)
    {
        ...
        Bounds bounds = SceneViewCameraBoundsUtility_Stage3.CalculateBounds(target);
    ...
    private void FreeLook(SceneViewCameraInput_Stage3 input, SceneViewCameraSettings_Stage3 settings)
    {
        if (!_freeLooking)
        {
            _freeLooking = true;
        ...
        _freeLookY = LocalRotationAndScale_Stage3.ClampAngle(_freeLookY, -89f, 89f);
    ...
    private void FlyMove(SceneViewCameraInput_Stage3 input, SceneViewCameraSettings_Stage3 settings)
    {
    ...
    private void AltRightDragZoom(SceneViewCameraInput_Stage3 input, SceneViewCameraSettings_Stage3 settings)
    {
        Vector3 mouseDelta = input.MousePosition - _lastMousePosition;
    ...
    private void Pan(SceneViewCameraInput_Stage3 input, SceneViewCameraSettings_Stage3 settings)
    {
    ...
    private void ZoomByMouseWheel(SceneViewCameraInput_Stage3 input, SceneViewCameraSettings_Stage3 settings)
    {
