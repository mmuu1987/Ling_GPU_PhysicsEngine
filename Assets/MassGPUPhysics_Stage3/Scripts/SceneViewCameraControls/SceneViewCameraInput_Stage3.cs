...
public struct SceneViewCameraInput_Stage3
{
...
public static class SceneViewCameraInputReader_Stage3
{
    public static SceneViewCameraInput_Stage3 Read(SceneViewCameraSettings_Stage3 settings)
    {
        return new SceneViewCameraInput_Stage3
        {
    ...
    private static bool IsMouseInsideInputArea(SceneViewCameraSettings_Stage3 settings)
    {
