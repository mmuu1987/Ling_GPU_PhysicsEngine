...
{
    internal readonly struct ScenarioGizmoUnit
    {
        ...
        public ScenarioGizmoUnit(UnitTypeConfig config, string roleName, Color color)
        {
            IsValid = config != null;
            ...
            Vector3 spawnSize = config != null && config.spawnConfig != null ? config.spawnConfig.ResolveSpawnSize() : Vector3.zero;
    ...
    internal readonly struct ScenarioGizmoFlowField
    {
        public readonly bool IsValid;
        ...
        public ScenarioGizmoFlowField(string label, Vector2 origin, int resolution, float cellSize, Color color)
        {
    ...
    internal readonly struct ScenarioGizmoSimulation
    {
        public readonly bool IsValid;
        public readonly Vector2 WorldSize;
        public readonly float CellSize;
        ...
        public ScenarioGizmoSimulation(Vector2 worldSize, float cellSize, Color color)
        {
            IsValid = true;
