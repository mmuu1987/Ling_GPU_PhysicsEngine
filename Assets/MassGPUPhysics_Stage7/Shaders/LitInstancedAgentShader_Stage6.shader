Shader "Universal Render Pipeline/MassGPUPhysics_Stage6/LitInstancedAgentShader_Stage6"
{
    // ============================================================
    // LitInstancedAgentShader_Stage6 — 带完整 URP 光照 + 阴影的 VAT 渲染 Shader。
    //
    // 【与 InstancedAgentShader_Stage6 的区别】
