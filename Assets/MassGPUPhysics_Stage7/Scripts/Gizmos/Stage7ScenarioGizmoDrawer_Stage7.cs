...
{
    internal static class Stage7ScenarioGizmoDrawer
    {
        ...
        public static void DrawSimulationBounds(
            Stage7ScenarioGizmoSimulation simulation,
            bool drawGrid,
            int gridStride,
            bool drawLabel,
            float labelYOffset)
        ...
        public static void DrawSpawnArea(Stage7ScenarioGizmoUnit unit, float fillAlpha, float outlineAlpha, bool drawLabel, float labelYOffset)
        {
            if (!unit.IsValid)
                return;
        ...
        public static void DrawFlowField(
            Stage7ScenarioGizmoFlowField flowField,
            bool drawGrid,
            int gridStride,
            bool drawLabel,
            float labelYOffset)
        ...
        public static void DrawFlowPreviewTexture(Stage7ScenarioGizmoFlowField flowField, Texture texture, float alpha, float yOffset)
        {
        ...
        public static void DrawConfiguredTarget(Stage7ScenarioGizmoUnit unit, float labelYOffset)
        {
        ...
        private static Material GetPreviewMaterial()
        {
            ...
            Shader shader = Shader.Find("MassGPUPhysics/Stage7/FlowFieldPreviewOverlay");
            if (shader == null)
                return null;
