...
public sealed class PaintedFlowFieldPainterWindow_Stage6 : EditorWindow
{
    private const string PainterComputePath = "Assets/MassGPUPhysics_Stage6/Shaders/PaintedFlowFieldPainter_Stage6.compute";

    private PaintedFlowFieldAsset_Stage6 asset;
    private PaintedFlowFieldAsset_Stage6 loadedAsset;
    ...
    [MenuItem("MassGPUPhysics/Stage6/Painted Flow Field Painter")]
    public static void ShowWindow()
    {
        GetWindow<PaintedFlowFieldPainterWindow_Stage6>("Painted Flow Field");
    }
    ...
    private void DrawToolbar()
    {
        ...
        manager = (GPUInstancingManager_Stage6)EditorGUILayout.ObjectField("Manager", manager, typeof(GPUInstancingManager_Stage6), true);
        asset = (PaintedFlowFieldAsset_Stage6)EditorGUILayout.ObjectField("Flow Field Asset", asset, typeof(PaintedFlowFieldAsset_Stage6), false);
    ...
    private void CreateAsset()
    {
        ...
        var created = CreateInstance<PaintedFlowFieldAsset_Stage6>();
    ...
    private void TryAdoptSelection()
    {
        ...
        var selectedManager = Selection.activeGameObject.GetComponent<GPUInstancingManager_Stage6>();
