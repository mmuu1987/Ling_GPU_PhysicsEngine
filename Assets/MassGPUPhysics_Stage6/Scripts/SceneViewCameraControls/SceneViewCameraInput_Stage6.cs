...
public struct SceneViewCameraInput_Stage6
{
...
public static class SceneViewCameraInputReader_Stage6
{
    public static SceneViewCameraInput_Stage6 Read(SceneViewCameraSettings_Stage6 settings)
    {
        return new SceneViewCameraInput_Stage6
        {
    ...
    private static bool IsMouseInsideInputArea(SceneViewCameraSettings_Stage6 settings)
    {
