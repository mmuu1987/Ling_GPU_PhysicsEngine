...
/// </summary>
public class MyCameraManager_Stage6 : MonoBehaviour
{
    [Header("Target")]
    ...
    private readonly SceneViewCameraRig_Stage6 _rig = new SceneViewCameraRig_Stage6();
    ...
    protected virtual void Start()
    {
        ...
        {
            Debug.LogError("[MyCameraManager_Stage6] No camera found. Assign ControlledCamera or enable CreateCameraIfMissing.");
            enabled = false;
            return;
        }
        ...
        _mouseOrbit = ControlledCamera.GetComponent<LocalRotationAndScale_Stage6>();
        if (_mouseOrbit == null)
            _mouseOrbit = ControlledCamera.gameObject.AddComponent<LocalRotationAndScale_Stage6>();
    ...
    private void Update()
    {
        ...
        SceneViewCameraSettings_Stage6 settings = BuildSettings();
        SceneViewCameraInput_Stage6 input = SceneViewCameraInputReader_Stage6.Read(settings);
    ...
    {
        return SceneViewCameraBoundsUtility_Stage6.TransformBounds(matrix, bounds);
    }

    private SceneViewCameraSettings_Stage6 BuildSettings()
    {
        return new SceneViewCameraSettings_Stage6
        {
