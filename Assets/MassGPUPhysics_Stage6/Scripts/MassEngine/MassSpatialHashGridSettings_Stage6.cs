...
public readonly struct MassSpatialHashGridSettings_Stage6
{
    ...
    private MassSpatialHashGridSettings_Stage6(int resolutionX, int resolutionZ, Vector2 worldSize, Vector2 origin)
    {
    ...
    public static MassSpatialHashGridSettings_Stage6 Calculate(
        ...
        float cellSize)
    {
        ...
        return new MassSpatialHashGridSettings_Stage6(resolutionX, resolutionZ, worldSize, origin);
    }

    public static MassSpatialHashGridSettings_Stage6 FromBounds(Vector2 min, Vector2 max, float cellSize)
    {
        cellSize = Mathf.Max(0.1f, cellSize);
        ...
        return new MassSpatialHashGridSettings_Stage6(resolutionX, resolutionZ, worldSize, min);
    }
}
